...
In this project, we explore several different algorithms (flavors) to
solve Maximum 0-1 Knapsack, a classic NP-Hard problem, \emph{in a
reasonable amount of time}. In our experiments, we want to show the
difference between running time and the optimal value obtained using
